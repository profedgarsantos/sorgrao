...
class PaisesController extends Controller
{
    ...
    {
        $items=Paises::where("empresa_id",$empresa->id)->get();
    ...
    public function store(Request $request)
    {
        ...
        $items=Paises::create($request->all());
    ...
    {
        $items=Paises::where("id",$id)->where("empresa_id",$empresa->id)->get();

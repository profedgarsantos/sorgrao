...
class GruposController extends Controller
{
    ...
    {
        $items=Grupos::where("empresa_id",$empresa->id)->get();
    ...
    public function store(Request $request)
    {
        ...
        $items=Grupos::create($request->all());
    ...
    {
        $items=Grupos::where("id",$id)->where("empresa_id",$empresa->id)->get();
